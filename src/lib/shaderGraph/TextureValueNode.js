...
`;
  ...
  float val = decodeFloatRGBA(texture2D(u_particles_x, v_tex_pos));
  // TODO WAS: for now just using (decoding) u_particles_x texture for value (to prevent breaking TextureCollection)
`
    }
    return `
